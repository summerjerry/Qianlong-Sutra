...
public class SutraDbHelper extends SQLiteOpenHelper {
  ...
  public class SutraPrimaryIndexItem {
    ...
    public boolean equals(Object object) {
      ...
      if (itemData.pIndex == null && this.pIndex != null || !itemData.pIndex.equals(this.pIndex)) {
        return false;
      }

      if (itemData.pName == null && this.pName != null || !itemData.pName.equals(this.pName)) {
        return false;
      }
  ...
  public class SutraSecondaryIndexItem {
    ...
    public boolean equals(Object object) {
      ...
      if (itemData.sIndex == null && this.sIndex != null || !itemData.sIndex.equals(this.sIndex)) {
        return false;
      }

      if (itemData.sName == null && this.sName != null || !itemData.sName.equals(this.sName)) {
        return false;
      }
  ...
  private final static String DB_ZIP_FINAL_PATH = DB_PATH + DB_ZIP_NAME;
  ...
  private void copyDataBase() throws IOException {
    ...
    myOutput.close();
    myInput.close();
    // ZipUtils.unZip(DB_ZIP_FINAL_PATH, DB_PATH);
  ...
  public List<SutraPrimaryIndexItem> getPrimaryIndex() {
    ...
    if (cur.moveToFirst()) {
      while (!cur.isAfterLast()) {
        ...
        list.add(
            new SutraPrimaryIndexItem(cur.getString(primaryIndex), cur.getString(primaryName)));
        cur.moveToNext();
      }
    }
