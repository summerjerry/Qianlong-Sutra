...
public class MainActivity extends BaseActivity implements DbListener {
  ...
  private SecondaryListAdapter mSearchAdapter = null;
  ...
  private OnItemClickListener mPrimaryListItemClickListener = new OnItemClickListener() {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      if (MainActivity.this.mPrimaryListAdapter != null
        ...
        String pIndex = MainActivity.this.mPrimaryListAdapter.getData().get(position).pIndex;
  ...
  private OnItemClickListener mSecondaryListItemClickListener = new OnItemClickListener() {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      if (MainActivity.this.mSecondaryListAdapter != null
        ...
        String sIndex = MainActivity.this.mSecondaryListAdapter.getData().get(position).sIndex;
        String sName = MainActivity.this.mSecondaryListAdapter.getData().get(position).sName;
  ...
  private OnItemClickListener mSearchListItemClickListener = new OnItemClickListener() {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
      if (MainActivity.this.mSearchAdapter != null
        ...
        String sIndex = MainActivity.this.mSearchAdapter.getData().get(position).sIndex;
        String sName = MainActivity.this.mSearchAdapter.getData().get(position).sName;
        Intent intent = new Intent(MainActivity.this, SutraDetailActivity.class);
        intent.putExtra(Intent.EXTRA_TEXT, sIndex);
        intent.putExtra(Intent.EXTRA_TITLE, sName);
        MainActivity.this.startActivity(intent);
  ...
  public class MainPagerAdapter extends PagerAdapter implements OnPageChangeListener {
    ...
    public MainPagerAdapter(Context context) {
      ...
      MainActivity.this.mPrimaryIndexListView.setAdapter(MainActivity.this.mPrimaryListAdapter);
      ...
      MainActivity.this.mSecondaryIndexListView.setAdapter(MainActivity.this.mSecondaryListAdapter);
      ...
      MainActivity.this.mHistoryListView = (ListView) historyPage.findViewById(R.id.list_history);
      ...
      MainActivity.this.mSearchListView = (ListView) searchPage.findViewById(R.id.list_history);
      MainActivity.this.mSearchAdapter = new SecondaryListAdapter(MainActivity.this);
    ...
    /**
     * Attention here! If you got a android ANR problem here,comment the super() method of
     * it.
     */
    @Override
  ...
  private void doSearch(String oldQuery) {
    ...
    if (Utils.isStringEmpty(query)) {
      Toast.makeText(this, this.getString(R.string.input_can_not_null), Toast.LENGTH_SHORT).show();
      return;
    }
    ...
    try {
      ...
      Toast.makeText(this, this.getString(R.string.input_can_not_known), Toast.LENGTH_SHORT).show();
      e.printStackTrace();
    }

    DbRequest.searchSecondaryIndexBySName(this, query);
  }

  private void doSearch() {
    this.doSearch(this.mSearchEdit.getText().toString());
  }
  ...
  private void switchToTab(Tab tab) {
    ...
    case TAB_SUTRA:
      ...
      Logger.log("Primary list is not null, count = " + this.mPrimaryListAdapter.getCount());
  ...
  public void onDbResponse(DbResponseData<?> data) {
    ...
    if (data instanceof DbSearchListData) {
      ...
      if (listData.isEmpty()) {
        Toast.makeText(this, this.getString(R.string.search_no_result), Toast.LENGTH_SHORT).show();
      } else {
        this.mSearchAdapter.setData(listData);
  ...
  private void setTabStyle() {
    switch (this.mCurrentTab) {
    case TAB_SUTRA:
      this.mSutraTextView.setBackgroundDrawable(SkinManager
      ...
      this.mHistoryTextView.setBackgroundDrawable(SkinManager
      ...
      this.mSearchTextView.setBackgroundDrawable(SkinManager
          .getDrawableById(R.drawable.tab_unselected));
  ...
  protected void onRefreshSkin() {
    ...
    this.mSutraTextView.setTextColor(SkinManager.getColorById(R.color.main_page_tab_text_color));
    this.mHistoryTextView.setTextColor(SkinManager.getColorById(R.color.main_page_tab_text_color));
    this.mSearchTextView.setTextColor(SkinManager.getColorById(R.color.main_page_tab_text_color));
    this.setTabStyle();
    ...
    this.mHistoryListView.setDivider(new ColorDrawable(SkinManager
        .getColorById(R.color.main_list_divider)));
    this.mHistoryListView.setBackgroundColor(SkinManager.getColorById(R.color.main_list_divider));
    this.mSearchListView.setDivider(new ColorDrawable(SkinManager
        .getColorById(R.color.main_list_divider)));
    this.mSearchListView.setBackgroundColor(SkinManager.getColorById(R.color.main_list_divider));
  ...
  protected void onRestart() {
    ...
    super.onRestart();
    if (this.mCurrentTab == Tab.TAB_SUTRA && this.mPrimaryListAdapter.isEmpty() && !this.mIsLoading) {
